...
export enum SelfEvaluationActionTypes {
  FETCH_SELF_EVALUATION_REQUESTED = "FETCH_SELF_EVALUATION_REQUESTED",
  FETCH_SELF_EVALUATION_SUCCESS = "FETCH_SELF_EVALUATION_SUCCESS",
  FETCH_SELF_EVALUATION_FAILURE = "FETCH_SELF_EVALUATION_FAILURE",
}

export enum AttachmentsActionTypes {
  FETCH_ATTACHMENTS_REQUESTED = "FETCH_ATTACHMENTS_REQUESTED",
