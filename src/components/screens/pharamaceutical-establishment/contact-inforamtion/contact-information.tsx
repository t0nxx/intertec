        ...
        <Container fluid>
            <Card>
                <Container>
                    <Card.Header>
                        <Row>
                            <FontAwesomeIcon icon={faPhone} size="lg" color="#127F46" className="ml-3 mr-2" />
                        ...
                        <Form>
                            <Form.Row>
                                <Form.Group as={Col} controlId="formGridEmail">
                                    <Form.Label>
                                        Contact Name <span className="required">*</span> </Form.Label>
                                    <Form.Control type="text" placeholder=" Contact Name" />
                                </Form.Group>

                                <Form.Group as={Col} controlId="formGridPassword">
                                    <Form.Label>
                                        Designation <span className="required">*</span> </Form.Label>
                            ...
                            <Form.Row>
                                <Form.Group as={Col} controlId="formGridEmail">
                                    <Form.Label>
                                        Primary Email <span className="required">*</span> </Form.Label>
                                    <Form.Control type="text" placeholder=" Primary Email" />
                                </Form.Group>

                                <Form.Group as={Col} controlId="formGridPassword">
                                    <Form.Label>
                                        Alternative Email <span className="required">*</span> </Form.Label>
                            ...
                            <Form.Row>
                                <Form.Group as={Col} controlId="formGridEmail">
                                    <Form.Label>
                                        Contact Number <span className="required">*</span> </Form.Label>
                                    <Form.Control type="text" placeholder=" +971 000 000 " />
                                </Form.Group>

                                <Form.Group as={Col} controlId="formGridPassword">
                                    <Form.Label>
                                        Alternative Contact Number <span className="required">*</span> </Form.Label>
                                    <Form.Control type="text" placeholder=" +971 000 000  " />
                                </Form.Group>
                            </Form.Row>
